...
Irssi::settings_add_str('ding', 'ding_sound', '/root/d/music/alert.mp3');
Irssi::settings_add_str('ding', 'ding_sound_hilight', '/root/d/music/alert.mp3');
Irssi::settings_add_str('ding', 'ding_sound_private_msg', '/root/d/music/alert.mp3');
